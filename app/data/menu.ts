...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Кутаб с курицей', description: 'тесто, сыр, курица, соус, зелень', price: 250, image: '/images/kutab.jpg' },
      { name: 'Анадолу с курицей', description: 'тесто, сыр, курица, фри, помидор, огурец, соус, зелень', price: 300, image: '/images/anadolu.jpg' },
      { name: 'Анадолу с говядиной', description: 'тесто, сыр, говядина, фри, помидор, огурец, соус, зелень', price: 370, image: '/images/anadolu.jpg' },
      { name: 'Пиде с курицей', description: 'тесто, сыр, курица, фри, помидор, соус, зелень', price: 250, image: '/images/pide-kuritsey.jpg' },
      { name: 'Хворост с курицей', description: 'курица, соус, крахмал, лепёшка, кетчуп, соль, перец', price: 270, image: '/images/hvorost.jpg' },
      { name: 'Кесадилья с курицей', description: 'лепёшка, сыр замесь, лук, болгарский, брокколи, кукуруза, курица, сметана, кетчуп, соль, перец', price: 230, image: '/images/kesadilya.jpg' },
      { name: 'Тамчы самсы', description: 'тесто, говядина, лук, специи, кунжут', price: 60, image: '/images/tamchy-samsy.jpg' },
      { name: 'Шаурма говядина', description: 'помидор, огурец, фри, кит. капуста, соус, говядина', price: 250, image: '/images/shaurma.jpg' },
      { name: 'Шаурма курица', description: 'помидор, огурец, фри, кит. капуста, соус, курица', price: 190, image: '/images/shaurma.jpg' },
    ],
  },
  {
    id: 'shashlyk',
